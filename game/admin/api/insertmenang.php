...
if (isset($_POST["submitmenang"])) {
    ...
    if ($_SESSION["nama_poss"] == "Remember Me") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahmenang WHERE id_post=1');
        $stmt->execute();
        ...
        if ($stmt->rowCount() == 1) {
            ...
            //INSERT POIN
            $stmtpoin = $conn->prepare("SELECT poin FROM game_hadiahmenang WHERE id_post=1");
            $stmtpoin->execute();
            $poin = $stmtpoin->fetch();
            ...
            $stmt4 = $conn->prepare("INSERT INTO `game_historykelompok`(`id_post`, `id_kelompok`, `status`) VALUES ('1','$get_id','menang')");
            $stmt4->execute();
    ...
    elseif ($_SESSION["nama_poss"] == "Kompak Please") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahmenang WHERE id_post=2');
        $stmt->execute();
        ...
        if ($stmt->rowCount() == 1) {
            ...
            //INSERT POIN
            $stmtpoin = $conn->prepare("SELECT poin FROM game_hadiahmenang WHERE id_post=2");
            $stmtpoin->execute();
            $poin = $stmtpoin->fetch();
            $insertpoint = $poin['poin'];
            ...
            $stmt4 = $conn->prepare("INSERT INTO `game_historykelompok`(`id_post`, `id_kelompok`, `status`) VALUES ('2','$get_id','menang')");
            $stmt4->execute();
    ...
    elseif ($_SESSION["nama_poss"] == "Mind The Mines") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahmenang WHERE id_post=3');
        $stmt->execute();
        ...
        if ($stmt->rowCount() == 1) {
            ...
            //INSERT POIN
            $stmtpoin = $conn->prepare("SELECT poin FROM game_hadiahmenang WHERE id_post=3");
            $stmtpoin->execute();
            $poin = $stmtpoin->fetch();
            $insertpoint = $poin['poin'];
            ...
            $stmt4 = $conn->prepare("INSERT INTO `game_historykelompok`(`id_post`, `id_kelompok`, `status`) VALUES ('3','$get_id','menang')");
            $stmt4->execute();
    ...
    elseif ($_SESSION["nama_poss"] == "Pass My Way") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahmenang WHERE id_post=4');
        $stmt->execute();
        ...
        if ($stmt->rowCount() == 1) {
            ...
            $quan_poin = $insertdatakelompok['poin'];
            //INSERT POIN
            $stmtpoin = $conn->prepare("SELECT poin FROM game_hadiahmenang WHERE id_post=4");
            $stmtpoin->execute();
            $poin = $stmtpoin->fetch();
            $insertpoint = $poin['poin'];
            ...
            $stmt4 = $conn->prepare("INSERT INTO `game_historykelompok`(`id_post`, `id_kelompok`, `status`) VALUES ('4','$get_id','menang')");
            $stmt4->execute();
    ...
    elseif ($_SESSION["nama_poss"] == "Toss tic tac tumble") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahmenang WHERE id_post=5');
        $stmt->execute();
        ...
        if ($stmt->rowCount() == 1) {
            ...
            //INSERT POIN
            $stmtpoin = $conn->prepare("SELECT poin FROM game_hadiahmenang WHERE id_post=5");
            $stmtpoin->execute();
            $poin = $stmtpoin->fetch();
            $insertpoint = $poin['poin'];
            ...
            $stmt4 = $conn->prepare("INSERT INTO `game_historykelompok`(`id_post`, `id_kelompok`, `status`) VALUES ('5','$get_id','menang')");
            $stmt4->execute();
    ...
    elseif ($_SESSION["nama_poss"] == "Blow For victory") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahmenang WHERE id_post=6');
        $stmt->execute();
        ...
        if ($stmt->rowCount() == 1) {
            ...
            $quan_poin = $insertdatakelompok['poin'];
            //INSERT POIN
            $stmtpoin = $conn->prepare("SELECT poin FROM game_hadiahmenang WHERE id_post=6");
            $stmtpoin->execute();
            $poin = $stmtpoin->fetch();
            $insertpoint = $poin['poin'];
            ...
            $stmt4 = $conn->prepare("INSERT INTO `game_historykelompok`(`id_post`, `id_kelompok`, `status`) VALUES ('6','$get_id','menang')");
            $stmt4->execute();
    ...
    if ($_SESSION["nama_poss"] == "Whos fast?") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahmenang WHERE id_post=7');
        $stmt->execute();
        ...
        if ($stmt->rowCount() == 1) {
            ...
            //INSERT POIN
            $stmtpoin = $conn->prepare("SELECT poin FROM game_hadiahmenang WHERE id_post=7");
            $stmtpoin->execute();
            $poin = $stmtpoin->fetch();
            $insertpoint = $poin['poin'];
            ...
            $stmt4 = $conn->prepare("INSERT INTO `game_historykelompok`(`id_post`, `id_kelompok`, `status`) VALUES ('7','$get_id','menang')");
            $stmt4->execute();
    ...
    if ($_SESSION["nama_poss"] == "Run and Run") {
        ...
        if ($stmt->rowCount() == 1) {
            ...
            $quan_poin = $insertdatakelompok['poin'];
            //INSERT POIN
            $stmtpoin = $conn->prepare("SELECT poin FROM game_hadiahmenang WHERE id_post=8");
            $stmtpoin->execute();
            $poin = $stmtpoin->fetch();
            $insertpoint = $poin['poin'];
            ...
            $stmt4 = $conn->prepare("INSERT INTO `game_historykelompok`(`id_post`, `id_kelompok`, `status`) VALUES ('8','$get_id','menang')");
            $stmt4->execute();
    ...
    if ($_SESSION["nama_poss"] == "A glimpse of hope") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahmenang WHERE id_post=9');
        $stmt->execute();
        ...
        if ($stmt->rowCount() == 1) {
            ...
            //INSERT POIN
            $stmtpoin = $conn->prepare("SELECT poin FROM game_hadiahmenang WHERE id_post=9");
            $stmtpoin->execute();
            $poin = $stmtpoin->fetch();
            $insertpoint = $poin['poin'];
            $rewardpoint = $insertpoint + $quan_poin;
            ...
            $stmt4 = $conn->prepare("INSERT INTO `game_historykelompok`(`id_post`, `id_kelompok`, `status`) VALUES ('9','$get_id','menang')");
            $stmt4->execute();
    ...
    if ($_SESSION["nama_poss"] == "Binding Tower") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahmenang WHERE id_post=10');
        $stmt->execute();
        ...
        if ($stmt->rowCount() == 1) {
            ...
            $stmt4 = $conn->prepare("INSERT INTO `game_historykelompok`(`id_post`, `id_kelompok`, `status`) VALUES ('10','$get_id','menang')");
            $stmt4->execute();
    ...
    if ($_SESSION["nama_poss"] == "Flowing Ball") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahmenang WHERE id_post=11');
        $stmt->execute();
        ...
        if ($stmt->rowCount() == 1) {
            ...
            //INSERT POIN
            $stmtpoin = $conn->prepare("SELECT poin FROM game_hadiahmenang WHERE id_post=11");
            $stmtpoin->execute();
            $poin = $stmtpoin->fetch();
            $insertpoint = $poin['poin'];
            ...
            $stmt4 = $conn->prepare("INSERT INTO `game_historykelompok`(`id_post`, `id_kelompok`, `status`) VALUES ('11','$get_id','menang')");
            $stmt4->execute();
    ...
    if ($_SESSION["nama_poss"] == "Multi drawers") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahmenang WHERE id_post=12');
        $stmt->execute();
        ...
        if ($stmt->rowCount() == 1) {
            ...
            //INSERT POIN
            $stmtpoin = $conn->prepare("SELECT poin FROM game_hadiahmenang WHERE id_post=12");
            $stmtpoin->execute();
            $poin = $stmtpoin->fetch();
            $insertpoint = $poin['poin'];
            ...
            $stmt4 = $conn->prepare("INSERT INTO `game_historykelompok`(`id_post`, `id_kelompok`, `status`) VALUES ('12','$get_id','menang')");
            $stmt4->execute();
    ...
    if ($_SESSION["nama_poss"] == "Tactile Whispers") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahmenang WHERE id_post=13');
        $stmt->execute();
        ...
        if ($stmt->rowCount() == 1) {
            ...
            //INSERT POIN
            $quan_poin = $insertdatakelompok['poin'];
            $stmtpoin = $conn->prepare("SELECT poin FROM game_hadiahmenang WHERE id_post=13");
            $stmtpoin->execute();
            $poin = $stmtpoin->fetch();
            $insertpoint = $poin['poin'];
            ...
            $stmt4 = $conn->prepare("INSERT INTO `game_historykelompok`(`id_post`, `id_kelompok`, `status`) VALUES ('13','$get_id','menang')");
            $stmt4->execute();
    ...
    if ($_SESSION["nama_poss"] == "Rubber Bond") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahmenang WHERE id_post=14');
        $stmt->execute();
        ...
        if ($stmt->rowCount() == 1) {
            ...
            //INSERT POIN
            $quan_poin = $insertdatakelompok['poin'];
            $stmtpoin = $conn->prepare("SELECT poin FROM game_hadiahmenang WHERE id_post=14");
            $stmtpoin->execute();
            $poin = $stmtpoin->fetch();
            $insertpoint = $poin['poin'];
            ...
            $stmt4 = $conn->prepare("INSERT INTO `game_historykelompok`(`id_post`, `id_kelompok`, `status`) VALUES ('14','$get_id','menang')");
            $stmt4->execute();
    ...
    if ($_SESSION["nama_poss"] == "Lets Have Fun") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahmenang WHERE id_post=15');
        $stmt->execute();
        ...
        if ($stmt->rowCount() == 1) {
            ...
            //INSERT POIN
            $quan_poin = $insertdatakelompok['poin'];
            $stmtpoin = $conn->prepare("SELECT poin FROM game_hadiahmenang WHERE id_post=15");
            $stmtpoin->execute();
            $poin = $stmtpoin->fetch();
            $insertpoint = $poin['poin'];
            ...
            $stmt4 = $conn->prepare("INSERT INTO `game_historykelompok`(`id_post`, `id_kelompok`, `status`) VALUES ('15','$get_id','menang')");
            $stmt4->execute();
    ...
    if ($_SESSION["nama_poss"] == "Find My Pair") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahmenang WHERE id_post=16');
        $stmt->execute();
        ...
        if ($stmt->rowCount() == 1) {
            ...
            $stmt4 = $conn->prepare("INSERT INTO `game_historykelompok`(`id_post`, `id_kelompok`, `status`) VALUES ('16','$get_id','menang')");
            $stmt4->execute();
