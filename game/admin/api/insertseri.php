...
if (isset($_POST["submitseri"])) {
    ...
    if ($_SESSION["nama_poss"] == "Tactile Whispers") {
        ...
        if ($stmt->rowCount() == 1) {
            ...
            $stmt3 = $conn->prepare("UPDATE game_kelompok SET poin='$rewardpoint', poin='$rewardpoint', qty_Copper='$rewardCopper', qty_Silikon='$rewardSilikon' WHERE nama='$nama_kelompok'");
            $stmt3->execute();
