...
if (isset($_POST["submitkalah"])) {
    ...
    elseif ($_SESSION["nama_poss"] == "Kompak Please") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahkalah WHERE id_post=2');
        $stmt->execute();
    ...
    elseif ($_SESSION["nama_poss"] == "Mind The Mines") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahkalah WHERE id_post=3');
        $stmt->execute();
    ...
    elseif ($_SESSION["nama_poss"] == "Pass My Way") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahkalah WHERE id_post=4');
        $stmt->execute();
    ...
    elseif ($_SESSION["nama_poss"] == "Toss tic tac tumble") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahkalah WHERE id_post=5');
        $stmt->execute();
    ...
    elseif ($_SESSION["nama_poss"] == "Blow For victory") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahkalah WHERE id_post=6');
        $stmt->execute();
    ...
    if ($_SESSION["nama_poss"] == "Whos fast?") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahkalah WHERE id_post=7');
        $stmt->execute();
    ...
    if ($_SESSION["nama_poss"] == "Run and Run") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahkalah WHERE id_post=8');
        $stmt->execute();
    ...
    if ($_SESSION["nama_poss"] == "A glimpse of hope") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahkalah WHERE id_post=9');
        $stmt->execute();
    ...
    if ($_SESSION["nama_poss"] == "Binding Tower") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahkalah WHERE id_post=10');
        $stmt->execute();
    ...
    if ($_SESSION["nama_poss"] == "Flowing Ball") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahkalah WHERE id_post=11');
        $stmt->execute();
    ...
    if ($_SESSION["nama_poss"] == "Multi drawers") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahkalah WHERE id_post=12');
        $stmt->execute();
    ...
    if ($_SESSION["nama_poss"] == "Tactile Whispers") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahkalah WHERE id_post=13');
        $stmt->execute();
    ...
    if ($_SESSION["nama_poss"] == "Lets Have Fun") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahkalah WHERE id_post=15');
        $stmt->execute();
    ...
    if ($_SESSION["nama_poss"] == "Find My Pair") {
        ...
        $stmt = $conn->prepare('SELECT * FROM game_hadiahkalah WHERE id_post=16');
        $stmt->execute();
