...
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Black+Ops+One&display=swap&effect=3d|fire|neon|shadow-multiple" rel="stylesheet">
...
#main-nav {
  background-color: rgb(112, 24, 92, 0.3);
}
...
.bagian::after {
  content: '';
  flex: 1;
  border-bottom: 1px solid #FDEAC4;
}

.bagian:not(:empty)::after {
  margin-left: .25em;
}
...
.form-control:focus {
  ...
  color: white;
  border-radius: 50px;
  box-shadow: inset 20px 20px 60px #292727,
    inset -20px -20px 60px #373535;
}
...
input:-webkit-autofill:active {
  -webkit-box-shadow: 0 0 0 30px #302e2e inset !important;
}
  ...
  <body>
        ...
        <nav id="main-nav" class="navbar navbar-dark fixed-top navbar-expand-lg ">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarContent">
                ...
                <button class="other nav-link btn px-4 mx-auto ms-lg-3" type="button" onclick="location.href='../logout.php'">
                    LOGIN
                </button>
                </ul>
            </div>
                ...
                <div class="col-12 col-md-7 mx-auto form-detail">
                    <form method="post" id="form-regist">
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <input type="text" class="form-control" name="asalsekolah" id="asalsekolah" placeholder="Enter Asal Sekolah">
                        </div>
                        <div class="col-12 mt-3">
                            <span>Nama Tim</span>
                            <input type="text" class="form-control" name="namatim" id="namatim" placeholder="Enter Nama Tim">
                        </div>
                        <div class="col-12 mt-3">
                            <span>Email Ketua Tim</span>
                            <input type="email" class="form-control" name="email" id="email" placeholder="Enter Email Ketua Tim">
                        </div>
                        <div class="col-12 mt-3">
                            <span>Password</span>
                            <input type="password" class="form-control" name="password" id="password" placeholder="Enter New Password">
                            <p style="color:red;display:none" class="panPas">Panjang minimal 8 karakter</p>
                        </div>
                        <div class="d-flex bagian mb-2 jdl2">DATA PESERTA 1 (KETUA TIM)</div>
                        <div class="col-12 mt-2">
                            <span>Nama Lengkap Peserta 1 (Ketua)</span>
                            <input type="text" class="form-control" name="namaketua" id="namaketua" placeholder="Enter Nama Lengkap Ketua">
                        </div>
                        <div class="col-12 mt-3">
                            <span>No WA Ketua</span>
                            <input type="text" class="form-control" name="nomerwa" id="nomerwa" placeholder="Enter Nomer WA Ketua">
                        </div>
                        <div class="col-12 mt-3">
                            <span>ID Line Ketua</span>
                            <input type="text" class="form-control" name="idline1" id="idline1" placeholder="Enter ID Line Ketua">
                        </div>
                        <div class="col-12 mt-3">
                        ...
                        <div class="d-flex bagian mb-2 jdl2">DATA PESERTA 2</div>
                        <div class="col-12 mt-2">
                            <span>Nama Lengkap Peserta 2</span>
                            <input type="text" class="form-control" name="namapeserta2" id="namapeserta2" placeholder="Enter Nama Lengkap Peserta 2">
                        </div>
                        <div class="col-12 mt-3">
                            <span>ID Line</span>
                            <input type="text" class="form-control" name="idline2" id="idline2" placeholder="Enter ID Line">
                        </div>
                        <div class="col-12 mt-3">
                            <span>Pas Foto 3x4</span>
                        ...
                        <div class="d-flex bagian mb-2 jdl2">DATA PESERTA 3</div>
                        <div class="col-12 mt-2">
                            <span>Nama Lengkap Peserta 3</span>
                            <input type="text" class="form-control" name="namapeserta3" id="namapeserta3" placeholder="Enter Nama Lengkap Peserta 3">
                        </div>
                        <div class="col-12 mt-3">
                            <span>ID Line</span>
                            <input type="text" class="form-control" name="idline3" id="idline3" placeholder="Enter ID Line">
                        </div>
                        <div class="col-12 mt-3">
                            <span>Pas Foto 3x4</span>
                        ...
                        <div class="col-12 mt-5">
                            <img class="gbrtrf mb-5" src="assets/QR.jpg" alt="QR CODE" width="400px"> <br>
    ...
    <script>
        $(document).ready(function()
        {
            ...
            $("#form-regist").on("submit", function(e){
                ...
                //if($("#masok").text() != "Loading..."){
                    $('.loading').css("display","block");
                    $('.defaultSub').css('display','none');
                $.ajax({
                    url: "pendaftaranproses.php",
                    method: "POST",
                    data: fd,
                    processData: false,
                    contentType: false,
            ...
            $('#password').on('keyup',function(){
                if($('#password').val().length < 8){
                    $('.panPas').css('display','block')
                }else{
                    $('.panPas').css('display','none')
                }
            })
        });
    </script>
