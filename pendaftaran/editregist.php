...
require_once "../connect.php";
  ...
  if(!isset($_SESSION['nama_kelompok'])){
    header("Location: login.php");
  }

  //query data
  $nama_kelompok = $_SESSION['nama_kelompok'];
  $query = "SELECT * FROM kelompok WHERE nama_kelompok = ?";
                ...
                <div class="col-12 col-md-7 mx-auto form-detail">
                    <form method="post" id="form-regist">
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <input type="text" class="form-control" name="asalsekolah" id="asalsekolah" value="<?=$data['asal_sekolah']?>" disabled>
                        </div>
                        <div class="col-12 mt-3">
                            <span>Nama Tim</span>
                            <input type="text" class="form-control" name="namatim" id="namatim" value="<?=$data['nama_kelompok']?>" disabled>
                        </div>
                        <div class="col-12 mt-3">
                        ...
                        <div class="col-12 mt-2">
                            ...
                            <input type="text" class="form-control" name="namaketua" id="namaketua" value="<?=$data['nama_ketua']?>">
                        </div>
                        <div class="col-12 mt-3">
                            <span>No WA Ketua</span>
                            <input type="text" class="form-control" name="nomerwa" id="nomerwa" value="<?=$data['nomerwa']?>">
                        </div>
                        <div class="col-12 mt-3">
                        ...
                        <div class="col-12 mt-2">
                            ...
                            <input type="text" class="form-control" name="namapeserta2" id="namapeserta2" value="<?=$data['nama_peserta2']?>">
                        </div>
                        <div class="col-12 mt-3">
                            <span>ID Line</span>
                        ...
                        <div class="col-12 mt-2">
                            ...
                            <input type="text" class="form-control" name="namapeserta3" id="namapeserta3" value="<?=$data['nama_peserta3']?>">
                        </div>
                        <div class="col-12 mt-3">
                            <span>ID Line</span>
